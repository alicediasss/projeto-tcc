...
// Query para listar os pedidos do banco
$querylistar1 = "SELECT * FROM _pedidos";
$dadospedidos = mysqli_query($conexao, $querylistar1) or die($mysqli->error);
$linhapedido = mysqli_fetch_assoc($dadospedidos);
...
<div class="limiter">
													...
													<table style="border:3px solid; width: 100%;">
														<thead>
															<tr style="border: 2px solid; font-weight: bold; text-align:center;">
																...
																<td style="border: 2px solid;">CPF do Cliente</td>
																<td style="border: 2px solid;">Valor</td>
															</tr>
														</thead>
														<tbody style="border-style:solid">
															<?php if (mysqli_num_rows($dadospedidos) > 0) {
																do {
															?>
																	<tr align="center">
																		<td style="border: 2px solid;"><?php echo $linhapedido["id"]; ?> </td>
																		<td style="border: 2px solid;"><?php echo $linhapedido["cliente"]; ?></td>
																		<td style="border: 2px solid;"><?php echo $linhapedido["valor"]; ?></td>
																	</tr>
															<?php } while ($linhapedido = mysqli_fetch_assoc($dadospedidos));
															}
															?>
														</tbody>
													</table>
    ...
    <button style="text-align:center; font-size: 15px;" type="input"><a href="cadastro_pedido.php">Novo Pedido</button>
